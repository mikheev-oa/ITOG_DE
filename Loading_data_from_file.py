...
# Загрузка из листа "Application_service"_
...
# Загрузка из листа Maintenance_repair_price_   
...
# Загрузка из листа Price_distinct_   
...
# Загрузка из листа Area_distance_  
...
# Загрузка из листа Сonsumption_price_  
